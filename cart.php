...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">	<a href="article.php?IDArticle=<?php echo $row['idItem'];?>">
           		<h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;"><?php echo $row['nameItem'];?></h2></a>
           	</div>
           	<div class="col-md-1">
           		<h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;"><?php echo $row['quantityCart'];?></h2>
           	</div>
           	<div class="col-md-1">
           		<h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;">$<?php echo $row['priceItem'];?>.00</h2>
           	</div>
			<div class="col-md-1">
           		<h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;">$<?php echo $row['totalCart'];?>.00</h2>
           	</div>
		</div>
		...
		<div class="col-md-12">
			...
			<div class ="col-md-3 text-center">
				<h2 style="font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;">Grand Total</h2><span style=" font-family: Mongolian Baltic; font-weight: bold; font-size: 20pt;color: #63563D;"> $<?php echo $total;?>.00</span>	
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<h2 class = "h2">Pay Method</h2>
				<hr/>
				<div class="row">
					<div class="col-md-12">
					<img src="imgs/credit_card.png" alt="credicardimg" class ="center" style="width:5%;"> <span style = "color: #63563D; font-size: 18.0pt;font-family: Mongolian Baiti;">Pay with Credit Card</span>
					
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<p class = "p">Placeholder Name</p>
						<input type="text" class ="input_account" id="cardholdername" name="cardholdername" value = "">
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
					<p class = "p">Expiration Date</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
					<select class="form-control-large" id="exp_dateone" name="exp_dateone" value = "">
							<option value="01"<?php echo ($row['exp_dateone']== 1) ? 'selected="selected"': ''; ?>>01</option>
							<option value="02"<?php echo ($row['exp_dateone']== 2) ? 'selected="selected"': ''; ?>>02</option>
							<option value="03"<?php echo ($row['exp_dateone']== 3) ? 'selected="selected"': ''; ?>>03</option>
							<option value="04"<?php echo ($row['exp_dateone']== 4) ? 'selected="selected"': ''; ?>>04</option>
							<option value="05"<?php echo ($row['exp_dateone']== 5) ? 'selected="selected"': ''; ?>>05</option>
							<option value="06"<?php echo ($row['exp_dateone']== 6) ? 'selected="selected"': ''; ?>>06</option>
							<option value="07"<?php echo ($row['exp_dateone']== 7) ? 'selected="selected"': ''; ?>>07</option>
							<option value="08"<?php echo ($row['exp_dateone']== 8) ? 'selected="selected"': ''; ?>>08</option>
							<option value="09"<?php echo ($row['exp_dateone']== 9) ? 'selected="selected"': ''; ?>>09</option>
							<option value="10"<?php echo ($row['exp_dateone']== 10) ? 'selected="selected"': ''; ?>>10</option>
							<option value="11"<?php echo ($row['exp_dateone']== 11) ? 'selected="selected"': ''; ?>>11</option>
							<option value="12"<?php echo ($row['exp_dateone']== 12) ? 'selected="selected"': ''; ?>>12</option>
					</select>
					</div>
					<div class="col-md-8">
					<select class="form-control-large" style = "margin-left: -30%;" id="exp_date" name="exp_date" value = "">
							    	<option value="2019"<?php echo ($row['exp_date']== 2019) ? 'selected="selected"': ''; ?>>2019</option>
							        <option value="2018"<?php echo ($row['exp_date']== 2018) ? 'selected="selected"': ''; ?>>2020</option>
    								<option value="2017"<?php echo ($row['exp_date']== 2017) ? 'selected="selected"': ''; ?>>2021</option>
    								<option value="2016"<?php echo ($row['exp_date']== 2016) ? 'selected="selected"': ''; ?>>2022</option>
    								<option value="2015"<?php echo ($row['exp_date']== 2015) ? 'selected="selected"': ''; ?>>2023</option>
    								<option value="2014"<?php echo ($row['exp_date']== 2014) ? 'selected="selected"': ''; ?>>2024</option>
    								<option value="2013"<?php echo ($row['exp_date']== 2013) ? 'selected="selected"': ''; ?>>2025</option>
    								<option value="2012"<?php echo ($row['exp_date']== 2012) ? 'selected="selected"': ''; ?>>2026</option>
    								<option value="2011"<?php echo ($row['exp_date']== 2011) ? 'selected="selected"': ''; ?>>2027</option>
    								<option value="2010"<?php echo ($row['exp_date']== 2010) ? 'selected="selected"': ''; ?>>2028</option>
    								<option value="2009"<?php echo ($row['exp_date']== 2009) ? 'selected="selected"': ''; ?>>2029</option>
    								<option value="2008"<?php echo ($row['exp_date']== 2008) ? 'selected="selected"': ''; ?>>2030</option>
    								<option value="2007"<?php echo ($row['exp_date']== 2007) ? 'selected="selected"': ''; ?>>2031</option>
    								<option value="2006"<?php echo ($row['exp_date']== 2006) ? 'selected="selected"': ''; ?>>2032</option>
    								<option value="2005"<?php echo ($row['exp_date']== 2005) ? 'selected="selected"': ''; ?>>2033</option>
				...
				<div class="row">
					<div class="col-md-12">
						<p class = "p">Card Code</p>
						<input type="text" class ="input_account" id="cardcode" name="cardcode" value = "">
					</div>
				</div>
				<div class="row">
				<div class="col-md-12">
				</br>
				<h2 style = "color: #63563D; font-size: 18.0pt;font-family: Mongolian Baiti;">Paypal</h2>
				<a href ="https://www.paypal.com/mx/home">
				<img src="imgs/paypal.png" alt="credicardimg" class ="center" style="width:30%;"></a>
				<hr/>
					</div>
					<div class="col-md-12">
					</br>
						<a href="purchase.php" class="mybutton-medium" allign="right"> COMPLETE ORDER</a>
					</div>
				</div>
			</div>
		</div>

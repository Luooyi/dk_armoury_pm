...
<div class="container">
		...
		<div class="col-md-1">
			...
			<img src="imgs/delete.png" alt="articlesdeletecart" class ="center" style="width:40%">
           		...
           		<div class="col-md-2">
					...
					<div class="col-md-6">
           		    <h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;"><?php echo $row['nameItem'];?></h2>
           		</div>
           		<div class="col-md-1">
		...
		<div class="col">
					...
					<div class ="col-md-3">
					<h2 style=" font-family: Mongolian Baltic; font-size: 20pt;color: #63563D;">Grand Total</h2>
		...
		</img src="imgs/credit_card.png" alt="ccard" class ="center" style="width:50%">Credit Card
		<h2 class = "h2">Pay with Credit Card</h2>
		...
		<input type="text" class ="input_account" id="cardholdername" name="cardholdername" value = "">
		<select class="form-control-medium" id="exp_dateone" name="exp_dateone" value = "">
			...
			<select class="form-control-mediumshort" id="exp_date" name="exp_date" value = "">
